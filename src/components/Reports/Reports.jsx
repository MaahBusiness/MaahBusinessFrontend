...
const Reports = () => {
  ...
  const loadReport = (reportId) => {
    ...
    // Standardize generated_by to be the username
    if (
      freshReport.generated_by &&
      typeof freshReport.generated_by === "object" &&
      freshReport.generated_by.username
    ) {
      freshReport.generated_by = freshReport.generated_by.username;
    }
