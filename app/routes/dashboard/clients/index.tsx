...
export default function ClientsPage({ actionData }: Route.ComponentProps) {
  ...
  return (
    <OrgPageShell orbs={["emerald", "blue"]}>
      ...
      <div className="min-w-0 flex-1 overflow-hidden rounded-xl border border-emerald-500/15 bg-card/80 shadow-sm backdrop-blur-sm">
